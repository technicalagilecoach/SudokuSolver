...
public Thickness BorderThickness => GetBorderThickness();
    ...
    private Thickness GetBorderThickness()
    {
        ...
        // Right border after columns 3 and 6 - contiguous lines
        if (Position.Column == 3 || Position.Column == 6)
            right = 2.0;
            
        // Bottom border after rows 3 and 6 - contiguous lines
    ...
    private SolidColorBrush GetBackgroundColor()
    {
        ...
        return HighlightType switch
        {
            ...
            HighlightType.AffectedColumn => new SolidColorBrush(Color.FromArgb(255, 255, 250, 240)), // Light orange
            HighlightType.AffectedBox => new SolidColorBrush(Color.FromArgb(255, 255, 250, 240)), // Light orange
